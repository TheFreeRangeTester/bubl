        ...
        (
          ...
          ranked_candidates as (
            select
              candidate.id,
              candidate.user_id,
              candidate.activity_text,
              candidate.feeling_text,
          ...
          selected_candidates as (
            select
              ...
              ranked_candidates.activity_text,
              ranked_candidates.feeling_text,
              ranked_candidates.category_id,
              ranked_candidates.subcategory_id,
              ranked_candidates.topic_id,
              ranked_candidates.language_code,
              ranked_candidates.cluster_label,
              ranked_candidates.week_id,
              ranked_candidates.created_at,
              ranked_candidates.expires_at,
              ranked_candidates.is_active,
              ranked_candidates.is_flagged
          ...
          select jsonb_agg(to_jsonb(selected_candidates) - 'sort_position' order by selected_candidates.sort_position)
